...
class TestIconPropertyGroup : public QObject
{
    Q_OBJECT
private Q_SLOTS:
    void testNull()
    {
        auto property = std::make_unique<IconPropertyGroup>();
    ...
    void testEmpty()
    {
        auto property = IconPropertyGroup::empty();
    ...
    {
        auto source = std::make_unique<IconPropertyGroup>();
        auto destination = std::make_unique<IconPropertyGroup>();

        QVERIFY(!source->hasAnyValue());
        QVERIFY(!destination->hasAnyValue());

        // Calling resolve on empty source and destination should have no effect.
        IconPropertyGroup::resolveProperties(source.get(), destination.get());
    ...
    void testDataStream()
    {
        auto group = testIconPropertyGroupInstance();
        ...
        auto readGroup = std::make_unique<IconPropertyGroup>();
...
QTEST_MAIN(TestIconPropertyGroup)

#include "TestIconPropertyGroup.moc"