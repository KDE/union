...
class TestSizePropertyGroup : public QObject
{
    Q_OBJECT
private Q_SLOTS:
    void testNull()
    {
        auto property = std::make_unique<SizePropertyGroup>();
    ...
    void testEmpty()
    {
        auto property = SizePropertyGroup::empty();
    ...
    {
        auto source = std::make_unique<SizePropertyGroup>();
        auto destination = std::make_unique<SizePropertyGroup>();

        QVERIFY(!source->hasAnyValue());
        QVERIFY(!destination->hasAnyValue());

        // Calling resolve on empty source and destination should have no effect.
        SizePropertyGroup::resolveProperties(source.get(), destination.get());
    ...
    void testDataStream()
    {
        auto group = testSizePropertyGroupInstance();
        ...
        auto readGroup = std::make_unique<SizePropertyGroup>();
...
QTEST_MAIN(TestSizePropertyGroup)

#include "TestSizePropertyGroup.moc"