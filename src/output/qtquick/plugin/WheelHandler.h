 ...
 *
 * \brief Describes the mouse wheel event. Ported from Kirigami
 */
class UnionWheelEvent : public QObject
{
    Q_OBJECT
...
public:
    UnionWheelEvent(QObject *parent = nullptr);
    ~UnionWheelEvent() override;
...
Q_SIGNALS:
     ...
     */
    void wheel(UnionWheelEvent *wheel);
...
private:
    ...
    // TODO: There is currently no way of accessing settings from Union. Implement this once that is done
    ...
    bool m_middleDraggingVerticalScrollBar = false;
    bool m_middleDraggingHorizontalScrollBar = false;
    // Same as QXcbWindow.
    ...
    UnionWheelEvent m_unionWheelEvent;
