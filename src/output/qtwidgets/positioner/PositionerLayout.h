 ...
 *
 * Note also that this is a QWidget purely to allow for the usage of
 ...
 * attached to.
 */
class PositionerLayout : public QWidget
{
    Q_OBJECT

public:
    PositionerLayout(const Union::Properties::StylePropertyGroup *properties, const QWidget *parentItem);
...
private:
    ...
    const Union::Properties::StylePropertyGroup *m_properties;
