...
private Q_SLOTS:
    ...
    void testHasAnyValue()
    {
        ...
        {
            // Assigning an empty property to a value should have no effect.
            property.setLeft(BorderProperty{});
            QVERIFY(!property.hasAnyValue());

            property.setLeft(testBorderPropertyInstance());
            QVERIFY(property.hasAnyValue());
        ...
        {
            // Assigning an empty property to a value should have no effect.
            property.setRight(BorderProperty{});
            QVERIFY(!property.hasAnyValue());

            property.setRight(testBorderPropertyInstance());
            QVERIFY(property.hasAnyValue());
        ...
        {
            // Assigning an empty property to a value should have no effect.
            property.setTop(BorderProperty{});
            QVERIFY(!property.hasAnyValue());

            property.setTop(testBorderPropertyInstance());
            QVERIFY(property.hasAnyValue());
        ...
        {
            // Assigning an empty property to a value should have no effect.
            property.setBottom(BorderProperty{});
            QVERIFY(!property.hasAnyValue());

            property.setBottom(testBorderPropertyInstance());
            QVERIFY(property.hasAnyValue());
    ...
    void testResolveProperties()
    {
        ...
        source.setLeft(testBorderPropertyInstance());
        source.setRight(testBorderPropertyInstance());
        source.setTop(testBorderPropertyInstance());
        source.setBottom(testBorderPropertyInstance());
